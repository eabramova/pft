...
public class TestBase {
	...
	protected void returnMainPageFromAddNewContactPage() {		
	...
	protected void fillNewContactPage(ContactData contact) {
	...
	protected void selectGroup(ContactGroupData group) {
		new Select(driver.findElement(By.name("new_group"))).selectByVisibleText(group.selectedgroup);
	}

	protected void bDateSelect(BirthDateData bdate) {
